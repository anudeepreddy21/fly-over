...
import { Card, CardHeader, CardContent, Button, IconButton, CardActions } from "@mui/material";
...
function Media(props) {
	...
	return (
		<Card variant="outlined" className="loaderRoot">
			...
			<Skeleton animation="wave" variant="rect" className="loaderMedia" />
			<CardContent>
				<React.Fragment>
